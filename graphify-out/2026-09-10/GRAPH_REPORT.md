...
## Corpus Check
- 233 files · ~1,120,581 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3943 nodes · 8727 edges · 247 communities (181 shown, 66 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 166 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9d9fa515`
...
Cohesion: 0.04
Nodes (75): datetime, Django settings for pass_map project.  Generated by 'django-admin startproject', _annotate_and_filter_ods_registry_against_gis(), _annotate_kind_filter_membership(), _annotate_personal_ogh_statuses(), _annotate_personal_total_areas(), _attach_folded_ods_action_to_passport(), _build_home_page_context() (+67 more)

### Community 11 - "test_adjacent_relations.py"
Cohesion: 0.08
Nodes (41): map_deferred_layer_specs(), _adjacent_layers_for_json_response(), _build_map_adjacent_dt_combined_sql(), _build_map_request_layer_branch(), _build_map_requests_sql(), _build_map_requests_sql_for_source(), _build_new_object_request_layer_branch(), _build_new_object_request_objects_sql() (+33 more)

### Community 12 - "_quote_ident"
Cohesion: 0.10
Nodes (59): get_hood_cte_prefix_sql(), get_hood_intersects_ha_sql(), get_hood_intersects_sql_suffix(), Returns (sql_suffix, [params]) to AND into a WHERE clause, e.g.       AND ST_Int, Leading ``WITH ha AS (...), `` fragment (comma included) and its params., ``AND ST_Intersects((SELECT g FROM ha), ...)`` when scope active/empty; empty st, _adjacent_nearby_meters(), _analiz_layers_for_geometry() (+51 more)
...
Cohesion: 0.06
Nodes (39): build_dgi_ownership_extra_sql(), build_dgi_renovation_extra_sql(), build_dgi_renovation_match_sql(), build_dgi_rent_extra_sql(), classify_dgi_ownership(), classify_dgi_renovation(), finalize_dgi_aprove_record(), normalize_dgi_aprove_payload() (+31 more)
...
Cohesion: 0.08
Nodes (32): AppConfig, is_inspector_for_approve(), delete_approve(), ApprovalConfig, ApproveAlreadyApprovedError, ApproveUserConflictError, attach_geometry_to_message(), create_case_with_geometry() (+24 more)
...
Cohesion: 0.10
Nodes (50): format_named_event_title(), Build secondary-event title with object names (or number fallbacks)., serialize_approve_option(), _event_case(), _login(), _message_with_attachment(), _primary_case(), Tests for approval events, chats, and unanimous approval. (+42 more)
...
Cohesion: 0.12
Nodes (44): _add_calendar_months(), add_case_participant(), _approvals_progress(), attachment_allowed_extensions(), attachment_max_bytes(), build_case_title_named(), build_home_notifications(), _case_approve_until() (+36 more)
...
Cohesion: 0.15
Nodes (28): _quote_ident(), AttrMapping, build_keyed_sync_plan(), _changed_predicate_sql(), _dry_run_keyed_counts(), _fetch_table_columns(), _iter_qgis_batches(), KeyedSyncPlan (+20 more)
...
Cohesion: 0.10
Nodes (29): addGeometryLayer(), adjacentBaseKey(), adjacentBaseStyle(), adjacentFeatureKey(), adjacentLayerForRoot(), adjacentLayerKey(), adjacentLayerLabel(), adjacentPulsePhase() (+21 more)

### Community 80 - "forms.py"
Cohesion: 0.14
Nodes (39): get_accessible_approve(), get_owner_id_for_username(), build_geometries_feature_collection(), Short approve payload for QGIS list/detail headers., GeoJSON FeatureCollection for QGIS map layers., serialize_approve_qgis_summary(), qgis_api_host_allowed(), Access rules for the QGIS approval API (Host allowlist). (+31 more)
...
Cohesion: 0.17
Nodes (19): AuthenticationForm, add_demo_values(), copy_assets(), export(), extract_element(), main(), make_standalone(), modal_elements() (+11 more)
...
Cohesion: 0.07
Nodes (44): _feature_select_sql(), build_layer_groups(), build_topopassport_layer_groups(), format_survey_page_title(), geom_to_wgs84_sql(), Build approval page title from work-layer Name and PassBrId., Return landing page title from work YardPoly → OznPoly → OdhPoly for TaskGUID., SQL expression returning proj4text for APPROVAL_WORK_SOURCE_SRID.      PostGIS 3 (+36 more)
...
Cohesion: 0.08
Nodes (44): _append_auto_remove_mask_parts(), _append_intersection_mask_union_part(), auto_remove_intersections(), _auto_remove_mask_context(), _auto_remove_source_tokens(), _beskhoz_min_core_area_m2(), _beskhoz_min_half_width_m(), check_dgi_intersections() (+36 more)
...
Cohesion: 0.09
Nodes (33): landing_page_config(), Page bootstrap config for approval templates (json_script)., batch_lookup_task_poly_meta(), _column_exists(), _empty_task_poly_meta(), _is_bottom_polygon_key(), _layer_panel_sort_key(), layer_stack_order() (+25 more)
...
Cohesion: 0.17
Nodes (32): _actor_context(), api_add_case_participant(), api_approve_case(), api_bootstrap(), api_case_detail(), api_change_case_owner(), api_create_adjacent_event(), api_create_case() (+24 more)
...
Cohesion: 0.20
Nodes (3): Tests for owned recap list/export/delete API., test_delete_recap_object_success(), test_get_recap_counts_by_request_ids_includes_owner_filter()
...
Cohesion: 0.11
Nodes (20): build_map_layer_load_order(), Progressive map layer loading for the approval landing page., Ordered specs for sequential client-side loading., Return GeoJSON features for one progressive load chunk., resolve_map_layer_features(), _build_dgi_split_features(), build_reference_layer_features(), _features_from_geojson_payload() (+12 more)
...
Cohesion: 0.28
Nodes (13): landing(), HttpResponse, test_landing_adjacent_message_when_roots_but_no_features(), test_landing_inspector_adjacent_roots_from_cases(), test_landing_scopes_work_to_selected_approve(), test_landing_with_adjacent_layers(), test_landing_with_case_only_n_roots(), test_landing_without_owner_shows_message_unchanged() (+5 more)

### Community 185 - "1. Upsert согласования (ingest)"
Cohesion: 0.16
Nodes (27): load_manifest(), load_work_anchor_geometry(), Return survey polygon GeoJSON (dict) for TaskGUID from work YardPoly → OznPoly →, build_schema_feature_collection(), build_topopassport_feature_collection(), build_work_feature_collection(), _max_features(), Load approval map features from mggt_asu.work / topopassport schemas. (+19 more)
...
Cohesion: 0.06
Nodes (69): EntryPointForm, geometry_intersects_allowed_hood(), geometry_norm: GeoJSON geometry dict (not Feature/FC)., actions(), add_object(), _auto_remove_square_table_name(), _build_asu_ods_url(), _build_where_clause() (+61 more)

### Community 192 - "Command"
Cohesion: 0.17
Nodes (21): _approve_label(), _batch_load_work_anchor_geometries(), build_home_approval_feature_collection(), _empty_collection(), _normalize_guid(), Home-map GeoJSON for approval objects (mggt_asu work + adjacent by n_root)., FeatureCollection of approval objects for the home map.      TaskGUID hits becom, Load survey polygons for many TaskGUIDs. First matching poly table wins. (+13 more)
...
Cohesion: 0.19
Nodes (11): build_home_notification_events(), Build a feed of approval-related change events for the home notifications modal., approval_notifications(), Template context shared across authenticated HTML pages., Tests for home notification change events feed., _secondary(), test_actions_page_shows_all_events_and_modal_link(), test_build_home_notification_events_excludes_own_new_approve() (+3 more)
...
Cohesion: 0.07
Nodes (37): _attach_drawn_request_to_passport(), _build_merge_allowed_sets(), _classify_ods_click_scenario(), _dedupe_merge_items(), _enrich_ods_interaction_and_geometry(), _find_gis_geometry_for_ods_short_root(), _get_owned_objects(), _load_home_objects_for_scope() (+29 more)
...
Cohesion: 0.22
Nodes (6): URL configuration for pass_map project.  The `urlpatterns` list routes URLs to v, Заявка на регистрацию пользователя: поля листа «Перечень» шаблона     «Шаблон дл, RegistrationRequestForm, RussianAuthenticationForm, Публичная форма подачи заявки на регистрацию пользователя., registration_request()
...
Cohesion: 0.10
Nodes (44): _adjacent_layer_for_root(), adjacent_layer_key(), adjacent_poly_tables(), adjacent_primary_schema_name(), _adjacent_property_pairs(), adjacent_root_ids(), adjacent_schema_name(), _adjacent_select_sql() (+36 more)
...
- **Why does `ExternalUser` connect `ExternalUser` to `geojson_dynamic.py`, `hood_scope.py`, `test_approval_events.py`, `runSaveAndExportFlow`, `views.py`, `test_registration_request.py`, `page_config.py`, `models.py`, `test_dgi_intersection_results.py`, `work_layer_label`, `Command`, `Any`, `_remove_intersections_from_geometry`, `test_approval_smoke.py`, `initOwnedMap`, `AppConfig`, `refreshAutoRemoveModalOptions`, `navigateApp`, `landing`?**
