...
## Corpus Check
- 233 files · ~1,119,580 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3930 nodes · 8696 edges · 248 communities (182 shown, 66 thin omitted)
...
### Community 7 - "home.js"
Cohesion: 0.10
Nodes (17): clearHomeOghSpecialModes(), closeHomeWorkflowModal(), dgiPctClass(), formatDgiCalculatedAt(), formatDgiPct(), isOwnedApprovalFilterKind(), isOwnedRequestFilterKind(), legendFilterGroup() (+9 more)
...
Cohesion: 0.05
Nodes (74): _annotate_and_filter_ods_registry_against_gis(), _annotate_kind_filter_membership(), _annotate_personal_ogh_statuses(), _annotate_personal_total_areas(), _attach_folded_ods_action_to_passport(), _build_home_page_context(), _build_owned_passports_geojson(), _build_personal_account_metrics() (+66 more)
...
Cohesion: 0.13
Nodes (30): bind_hood_scope(), clear_hood_scope(), get_hood_allowed_districts_geojson(), get_hood_cte_prefix_and_intersects_clause(), _hood_min_overlap_ratio(), _hood_owner_geom_union_sql_and_params(), _hood_owner_union_cte_sql(), _hood_spatial_scope_active() (+22 more)

### Community 17 - "test_dgi_layers.py"
Cohesion: 0.06
Nodes (39): build_dgi_ownership_extra_sql(), build_dgi_renovation_extra_sql(), build_dgi_renovation_match_sql(), build_dgi_rent_extra_sql(), classify_dgi_ownership(), classify_dgi_renovation(), normalize_dgi_aprove_payload(), DGI sub-layer classification by zemlepol_dgi, short_sobstv_rr, and rent. (+31 more)
...
Cohesion: 0.13
Nodes (20): AppConfig, is_inspector_for_approve(), delete_approve(), ApprovalConfig, create_case_with_geometry(), create_event_from_adjacent(), delete_approve_for_inspector(), delete_inspector_own_message() (+12 more)
...
Cohesion: 0.15
Nodes (39): _ensure_inspector(), _post_qgis_approve(), _qgis_delete(), _qgis_get(), _qgis_post_json(), Tests for QGIS approval ingest API., test_aggregates_n_root_and_owners_on_approve(), test_create_approve_when_task_owner_matches_n_root_owner() (+31 more)
...
Cohesion: 0.09
Nodes (52): build_case_title_named(), format_named_event_title(), Build secondary-event title with object names (or number fallbacks)., Named display title for a secondary case, or None when not applicable.      Uses, _event_case(), _login(), _message_with_attachment(), _primary_case() (+44 more)
...
Cohesion: 0.15
Nodes (37): _add_calendar_months(), add_case_participant(), _approvals_progress(), attachment_allowed_extensions(), attachment_max_bytes(), _case_approve_until(), _case_display_status(), _case_is_fully_approved() (+29 more)
...
Cohesion: 0.20
Nodes (12): addSignalTapeLayer(), bindPdfExportLink(), captureMapCanvasForPdf(), formatDgiShortSobstvRr(), refreshLayerPanelCounts(), refreshObjectLayersControl(), renderReferenceSignalLayers(), renderRelationLayers() (+4 more)
...
Cohesion: 0.08
Nodes (26): 10. Удаление сообщения, 11. Участники события, 12. Смежное событие, 13. Удаление согласования, 2. Список согласований, 3. Деталь согласования, 4. Геометрии (слой для карты QGIS), 5. Деталь события / чат (+18 more)
...
Cohesion: 0.12
Nodes (25): aggregate_approve_owners(), _merge_case_owners_preserving_extras(), Keep inspector-added owners that are not part of the QGIS owner set., resolve_event_case_owners(), _sync_primary_case_fields(), upsert_approve_from_qgis(), _upsert_qgis_event_cases(), validate_case_owners() (+17 more)
...
Cohesion: 0.47
Nodes (4): proceedAfterGate(), setButtonLoading(), setExportLabel(), showConfirmModal()

### Community 85 - "refreshAutoRemoveModalOptions"
Cohesion: 0.07
Nodes (48): landing_page_config(), Page bootstrap config for approval templates (json_script)., build_topopassport_feature_collection(), _feature_select_sql(), build_layer_groups(), build_topopassport_layer_groups(), format_survey_page_title(), layer_stack_order() (+40 more)
...
Cohesion: 0.18
Nodes (11): bindOwnedOpenApprovalButton(), closeEntryRecapModal(), closeEntryRequestModal(), fillAndSubmitOdsOpenOwnedForm(), getEntryGeometryDetailMode(), handleEntryRequestCancel(), navigateApp(), openEntryRequestModal() (+3 more)
...
Cohesion: 0.09
Nodes (38): geometry_intersects_allowed_hood(), geometry_norm: GeoJSON geometry dict (not Feature/FC)., _append_auto_remove_mask_parts(), _append_intersection_mask_union_part(), auto_remove_intersections(), _auto_remove_mask_context(), _auto_remove_source_tokens(), check_new_object_relations() (+30 more)
...
Cohesion: 0.12
Nodes (24): AuthenticationForm, URL configuration for pass_map project.  The `urlpatterns` list routes URLs to v, RussianAuthenticationForm, add_object(), _load_home_objects_for_scope(), Return (owned_objects, ods_user_brids) for home based on user role scope., add_demo_values(), copy_assets() (+16 more)
...
Cohesion: 0.20
Nodes (30): _actor_context(), api_add_case_participant(), api_approve_case(), api_bootstrap(), api_case_detail(), api_change_case_owner(), api_create_adjacent_event(), api_create_case() (+22 more)
...
Cohesion: 0.15
Nodes (30): _adjacent_layer_for_root(), adjacent_layer_key(), adjacent_poly_tables(), adjacent_primary_schema_name(), _adjacent_property_pairs(), adjacent_schema_name(), _adjacent_select_sql(), _append_features() (+22 more)
...
Cohesion: 0.15
Nodes (21): adjacentFeatureDisplayName(), bindReferenceLayerPopup(), ensureLayerGroup(), escapeHtml(), findManagedGroupContaining(), formatDgiShortSobstvRr(), isAdjacentLayerKey(), isAdjacentParentLayerChecked() (+13 more)
...
Cohesion: 0.17
Nodes (25): addGeo(), applyObjectToggle(), applySignalTape(), boot(), clearMapLayers(), csrfToken(), ensureMap(), ensureSignalPattern() (+17 more)
...
Cohesion: 0.19
Nodes (7): delete_recap_object(), _get_owned_recap_row(), _get_recap_counts_by_request_ids(), _recaps_owner_scope_columns(), Tests for owned recap list/export/delete API., test_delete_recap_object_success(), test_get_recap_counts_by_request_ids_includes_owner_filter()
...
Cohesion: 0.14
Nodes (20): Progressive map layer loading for the approval landing page., _build_dgi_split_features(), build_reference_layer_features(), _features_from_geojson_payload(), load_work_anchor_geometry(), Reference map layers (dgi/oozt/renew/rzd) near the approval survey object., Load ДГИ as four ownership×rent buckets; tag each feature with dgiSubKey., Load dgi / oozt / renew / rzd features within APPROVAL_REFERENCE_BUFFER_METERS (+12 more)

### Community 181 - "svgIconUrl"
Cohesion: 0.20
Nodes (11): encodeSvgPath(), getSvgHotspots(), getSvgIndex(), hotspotBasenameFromIconUrl(), isUnknownSvgPath(), lookupSvgHotspot(), normalizeSvgLookupKey(), photoFixIconUrl() (+3 more)
...
Cohesion: 0.11
Nodes (38): build_schema_feature_collection(), build_work_feature_collection(), _max_features(), Load approval map features from mggt_asu.work / topopassport schemas., GeoJSON polygon (EPSG:4326) of the survey object for the first matching guid., _should_clip_table_to_work(), _style_fields_for_table(), _work_boundary_geojson_for_guids() (+30 more)

### Community 186 - "cancelCommentPointMode"
Cohesion: 0.14
Nodes (21): bindOwnedAsuOdsButton(), bindOwnedCheckDgiButton(), bindOwnedListIconActions(), bindOwnedViewObjectButton(), checkOwnedFeatureDgiIntersections(), closeCheckDgiModal(), closeOwnedViewObjectModal(), findOwnedFeatureLayer() (+13 more)

### Community 187 - "ExternalUser"
Cohesion: 0.24
Nodes (5): BaseBackend, DockerUsersTableBackend, Create or update the E2E test user in the users table (idempotent)., ExternalUser, Meta

### Community 188 - "Command"
Cohesion: 0.18
Nodes (14): build_map_layer_load_order(), Ordered specs for sequential client-side loading., load_work_layer_labels(), Path, Parse Russian layer titles from create_work.sql COMMENT ON TABLE., _sql_path(), work_layer_label(), test_build_map_layer_load_order() (+6 more)
...
Cohesion: 0.06
Nodes (62): finalize_dgi_aprove_record(), Apply server-side username and timestamp defaults before DB write., EntryPointForm, actions(), _analiz_layers_for_geometry(), _auto_remove_square_table_name(), _build_asu_ods_url(), _build_where_clause() (+54 more)

### Community 192 - "Command"
Cohesion: 0.21
Nodes (18): _approve_label(), _batch_load_work_anchor_geometries(), build_home_approval_feature_collection(), _empty_collection(), _normalize_guid(), Home-map GeoJSON for approval objects (mggt_asu work + adjacent by n_root)., FeatureCollection of approval objects for the home map.      TaskGUID hits becom, Load survey polygons for many TaskGUIDs. First matching poly table wins. (+10 more)
...
### Community 194 - "build_keyed_sync_plan"
Cohesion: 0.29
...
Cohesion: 0.09
Nodes (50): get_accessible_approves(), get_accessible_cases_queryset(), get_owner_ids_for_username(), matching_case_owner_id(), _normalize_owner_ids_arg(), _normalized_participant_logins(), _owners_q_for_ids(), Access control for approval workflows. (+42 more)
...
Cohesion: 0.12
Nodes (20): _build_merge_allowed_sets(), _dedupe_merge_items(), main(), _merge_item_is_allowed(), _merge_owned_ods_requests(), _normalize_merge_items(), _normalize_source_label(), open_merged_passports() (+12 more)
...
### Community 209 - "import_ozn_geojson.py"
Cohesion: 0.43
...
### Community 217 - "test_approval_map_layer_api.py"
Cohesion: 0.47
...
Cohesion: 0.50
Nodes (4): Host allowlist, Доступ и безопасность, Логин (`user`), Настройки (`.env`)
...
Cohesion: 0.33
Nodes (4): Заявка на регистрацию пользователя: поля листа «Перечень» шаблона     «Шаблон дл, RegistrationRequestForm, Публичная форма подачи заявки на регистрацию пользователя., registration_request()

### Community 229 - "header.js"
Cohesion: 0.14
Nodes (18): asuOdsPopupMeta(), bindOwnedAsuOdsButton(), buildOwnedMapKey(), dashDisplay(), fillOwnedPopupExtraFields(), getCsrfToken(), getOwnedFilterKindFromItem(), getOwnedFilterKindFromProps() (+10 more)
...
Cohesion: 0.08
Nodes (42): get_owner_id_for_username(), Return GeoJSON features for one progressive load chunk., resolve_map_layer_features(), api_map_layer(), landing(), adjacent_root_ids(), adjacent_source_label(), collect_adjacent_roots() (+34 more)
...
Cohesion: 0.13
Nodes (17): add_recap(), _attach_drawn_request_to_passport(), _classify_ods_click_scenario(), _enrich_ods_interaction_and_geometry(), _find_gis_geometry_for_ods_short_root(), _get_owned_ods_request_for_recap(), _merge_personal_drawn_requests_into_passports(), _norm_registry_id() (+9 more)
...
- **Why does `requestId()` connect `add-recap.js` to `add-object.js`, `split_object.js`, `renderRelationLayers`, `runSaveAndExportFlow`, `renderRelationLayers`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `ExternalUser` connect `ExternalUser` to `geojson_dynamic.py`, `hood_scope.py`, `test_approval_events.py`, `runSaveAndExportFlow`, `views.py`, `test_registration_request.py`, `page_config.py`, `models.py`, `test_dgi_intersection_results.py`, `work_layer_label`, `Command`, `_remove_intersections_from_geometry`, `test_approval_smoke.py`, `initOwnedMap`, `AppConfig`, `refreshAutoRemoveModalOptions`, `test_approval_map_layer_api.py`, `landing`, `add_recap`?**
