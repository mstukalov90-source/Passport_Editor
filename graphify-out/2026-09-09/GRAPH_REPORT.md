# Graph Report - GeoDjango  (2026-09-08)

## Corpus Check
- 229 files · ~1,114,792 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3855 nodes · 8548 edges · 233 communities (168 shown, 65 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 166 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d1240fa`
...
- `test_serialize_approve_options_uses_batch_meta()` --calls--> `serialize_approve_options()`  [EXTRACTED]
...
## Communities (233 total, 65 thin omitted)
...
Cohesion: 0.05
Nodes (72): datetime, Django settings for pass_map project.  Generated by 'django-admin startproject', _annotate_and_filter_ods_registry_against_gis(), _annotate_kind_filter_membership(), _annotate_personal_ogh_statuses(), _annotate_personal_total_areas(), _attach_folded_ods_action_to_passport(), _build_home_page_context() (+64 more)
...
Cohesion: 0.11
Nodes (26): applyCutGeometry(), applyGeometryToEditableGroup(), autoRemoveIntersections(), buildCurrentGeometry(), buildCurrentGeometryFromSelected(), buildExportGeometry(), checkDgiIntersections(), clearPendingRepairedGeometry() (+18 more)
...
Cohesion: 0.06
Nodes (69): finalize_dgi_aprove_record(), Apply server-side username and timestamp defaults before DB write., EntryPointForm, actions(), add_object(), _build_asu_ods_url(), _build_merge_allowed_sets(), _build_where_clause() (+61 more)
...
Cohesion: 0.10
Nodes (24): addSignalTapeLayer(), bindCommentPointLayer(), bindPdfExportLink(), buildCommentPointPopupHtml(), cancelCommentPointMode(), captureMapCanvasForPdf(), closeCommentPointModal(), closeDeletePolygonModal() (+16 more)
...
Cohesion: 0.07
Nodes (50): BaseBackend, Client, DockerUsersTableBackend, Create or update the E2E test user in the users table (idempotent)., ExternalUser, Meta, Tests for progressive approval map-layer API., test_api_map_layer_missing_approve_returns_404() (+42 more)
...
Cohesion: 0.09
Nodes (51): format_named_event_title(), Build secondary-event title with object names (or number fallbacks)., serialize_approve_option(), _event_case(), _login(), _message_with_attachment(), _primary_case(), Tests for approval events, chats, and unanimous approval. (+43 more)
...
Cohesion: 0.11
Nodes (48): api_bootstrap(), _add_calendar_months(), add_case_participant(), _approvals_progress(), attach_geometry_to_message(), attach_title_named(), build_case_title_named(), build_geometries_feature_collection() (+40 more)
...
Cohesion: 0.29
Nodes (9): _build_dgi_split_features(), build_reference_layer_features(), _features_from_geojson_payload(), Reference map layers (dgi/oozt/renew/rzd) near the approval survey object., Load ДГИ as four ownership×rent buckets; tag each feature with dgiSubKey., Load dgi / oozt / renew / rzd features within APPROVAL_REFERENCE_BUFFER_METERS, reference_buffer_meters(), test_build_reference_layer_features_dgi_tags_subkeys() (+1 more)
...
Cohesion: 0.16
Nodes (17): buildNewGeometryBeyondSelected(), checkRelations(), countPolygonLikeGeometriesInCollection(), extractPolygonGeometriesFromCollection(), fetchMapLayersJson(), fetchPdfExportData(), filterOutSelectedRootid(), hasNewPolygonBeyondSelected() (+9 more)
...
Cohesion: 0.19
Nodes (31): get_accessible_approve(), get_cases_queryset(), qgis_api_host_allowed(), Access rules for the QGIS approval API (internal host only)., request_host_name(), api_qgis_add_case_participant(), api_qgis_approve_by_guid(), api_qgis_approve_case() (+23 more)
...
Cohesion: 0.13
Nodes (25): get_accessible_cases_queryset(), _normalize_owner_ids_arg(), user_can_access_case(), aggregate_approve_owners(), resolve_event_case_owners(), _sync_primary_case_fields(), validate_case_owners(), Unit tests for approval access rules and inspector approvals. (+17 more)
...
Cohesion: 0.07
Nodes (49): Serialize approves with one batch poly-meta lookup for TaskGUIDs., serialize_approve_options(), landing_page_config(), Page bootstrap config for approval templates (json_script)., _feature_select_sql(), _should_clip_table_to_work(), build_layer_groups(), format_survey_page_title() (+41 more)
...
Cohesion: 0.15
Nodes (31): load_manifest(), adjacent_poly_tables(), adjacent_primary_schema_name(), _adjacent_property_pairs(), adjacent_schema_name(), _adjacent_select_sql(), _append_features(), build_adjacent_features() (+23 more)
...
Cohesion: 0.13
Nodes (23): get_owner_id_for_username(), AuthenticationForm, URL configuration for pass_map project.  The `urlpatterns` list routes URLs to v, RussianAuthenticationForm, add_demo_values(), copy_assets(), export(), extract_element() (+15 more)
...
Cohesion: 0.16
Nodes (39): is_inspector_for_approve(), _actor_context(), api_add_case_participant(), api_approve_case(), api_case_detail(), api_change_case_owner(), api_create_adjacent_event(), api_create_case() (+31 more)
...
Cohesion: 0.15
Nodes (11): delete_recap_object(), export_recap_geometry(), _get_current_user_owner_id(), _get_owned_recap_row(), _get_owned_recaps_for_request(), _get_recap_counts_by_request_ids(), list_owned_recaps(), _recaps_owner_scope_columns() (+3 more)
...
Cohesion: 0.11
Nodes (19): build_map_layer_load_order(), Progressive map layer loading for the approval landing page., Ordered specs for sequential client-side loading., Return GeoJSON features for one progressive load chunk., resolve_map_layer_features(), api_map_layer(), build_topopassport_feature_collection(), build_work_feature_collection() (+11 more)
...
Cohesion: 0.11
Nodes (38): load_work_anchor_geometry(), Return survey polygon GeoJSON (dict) for TaskGUID from work YardPoly → OznPoly →, batch_lookup_task_poly_meta(), _column_exists(), count_features_by_table(), count_topopassport_features_by_table(), _empty_task_poly_meta(), _is_bottom_polygon_key() (+30 more)
...
Cohesion: 0.07
Nodes (47): geometry_intersects_allowed_hood(), geometry_norm: GeoJSON geometry dict (not Feature/FC)., _append_auto_remove_mask_parts(), _append_intersection_mask_union_part(), auto_remove_intersections(), _auto_remove_mask_context(), _auto_remove_source_tokens(), _auto_remove_square_table_name() (+39 more)
...
Cohesion: 0.09
Nodes (47): get_accessible_approves(), get_owner_ids_for_username(), matching_case_owner_id(), _normalized_participant_logins(), _owners_q_for_ids(), Access control for approval workflows., First of the user's owner ids that appears in case.owners (for CaseApproval slot, SUP is read-only; other roles may mutate when otherwise authorized. (+39 more)
...
Cohesion: 0.20
Nodes (15): bindOwnedAsuOdsButton(), bindOwnedCheckDgiButton(), bindOwnedListIconActions(), checkOwnedFeatureDgiIntersections(), closeCheckDgiModal(), findOwnedFeatureLayer(), getCsrfToken(), normalizeOwnedCheckGeometry() (+7 more)
...
Cohesion: 0.09
Nodes (23): add_recap(), _attach_drawn_request_to_passport(), _classify_ods_click_scenario(), _enrich_ods_interaction_and_geometry(), _find_gis_geometry_for_ods_short_root(), _get_owned_ods_request_for_recap(), _load_home_objects_for_scope(), _merge_owned_ods_requests() (+15 more)
...
### Community 236 - "refreshAutoRemoveModalOptions"
Cohesion: 0.29
Nodes (7): countGroupFeatures(), isAutoRemoveSourceDisplayed(), openAutoRemoveModal(), refreshAutoRemoveModalOptions(), refreshLayerPanelCounts(), resetAutoRemoveCheckboxes(), syncLayerPanelCheckboxes()
...
## Knowledge Gaps
- **629 isolated node(s):** `Migration`, `Migration`, `Migration`, `Migration`, `Migration` (+624 more)
...
- **Why does `ExternalUser` connect `views.py` to `test_approval_events.py`, `_remove_intersections_from_geometry`, `runSaveAndExportFlow`, `page_config.py`, `geojson_dynamic.py`, `initOwnedMap`, `AppConfig`, `models.py`, `hood_scope.py`, `test_dgi_intersection_results.py`, `openOwnedObjectForView`, `work_layer_label`, `refreshAutoRemoveModalOptions`, `urls.py`, `work_layers.py`?**
