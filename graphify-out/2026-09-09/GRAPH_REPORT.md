...
## Corpus Check
- 232 files · ~1,116,571 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3891 nodes · 8612 edges · 245 communities (179 shown, 66 thin omitted)
...
## Communities (245 total, 66 thin omitted)
...
Cohesion: 0.04
Nodes (73): datetime, Django settings for pass_map project.  Generated by 'django-admin startproject', _annotate_and_filter_ods_registry_against_gis(), _annotate_kind_filter_membership(), _annotate_personal_ogh_statuses(), _annotate_personal_total_areas(), _attach_folded_ods_action_to_passport(), _build_home_page_context() (+65 more)
...
Cohesion: 0.12
Nodes (21): applyPopupHighlight(), bindCommentPointLayer(), buildCommentPointPopupHtml(), cancelCommentPointMode(), checkDgiIntersections(), clearPopupHighlight(), closeCheckDgiModal(), closeCommentPointModal() (+13 more)
...
Cohesion: 0.07
Nodes (60): EntryPointForm, resolve_user_scope(), actions(), add_object(), _analiz_layers_for_geometry(), _auto_remove_square_table_name(), _build_asu_ods_url(), _build_where_clause() (+52 more)
...
Cohesion: 0.25
Nodes (9): bindPdfExportLink(), buildNewGeometryBeyondSelected(), captureMapCanvasForPdf(), countPolygonLikeGeometriesInCollection(), extractPolygonGeometriesFromCollection(), fetchPdfExportData(), hasNewPolygonBeyondSelected(), runPdfExportDownload() (+1 more)
...
Cohesion: 0.20
Nodes (13): RegistrationRequest, _filtered_requests(), _is_mggt(), _list_url(), Публичная форма заявки на регистрацию и страницы просмотра заявок для МГГТ., Выгрузка заявок в .xlsx по шаблону «Шаблон для добавления пользователей.xlsx»., Подтверждение отправки заявки., Список заявок на регистрацию для сотрудников МГГТ. (+5 more)
...
Cohesion: 0.15
Nodes (17): _build_merge_allowed_sets(), _dedupe_merge_items(), main(), _merge_group_ids_by_source(), _merge_item_is_allowed(), _normalize_merge_items(), _normalize_source_label(), open_merged_passports() (+9 more)
...
Cohesion: 0.08
Nodes (45): geometry_intersects_allowed_hood(), geometry_norm: GeoJSON geometry dict (not Feature/FC)., _append_auto_remove_mask_parts(), _append_intersection_mask_union_part(), auto_remove_intersections(), _auto_remove_mask_context(), _auto_remove_source_tokens(), _beskhoz_min_core_area_m2() (+37 more)
...
### Community 215 - "test_approval_map_layer_api.py"
Cohesion: 0.47
...
### Community 217 - "legendFilterGroup"
Cohesion: 0.67
...
- **Why does `ExternalUser` connect `ExternalUser` to `geojson_dynamic.py`, `hood_scope.py`, `urls.py`, `work_layers.py`, `test_approval_events.py`, `runSaveAndExportFlow`, `views.py`, `test_registration_request.py`, `page_config.py`, `models.py`, `test_dgi_intersection_results.py`, `work_layer_label`, `_remove_intersections_from_geometry`, `test_approval_smoke.py`, `initOwnedMap`, `AppConfig`, `openOwnedObjectForView`, `refreshAutoRemoveModalOptions`, `test_approval_map_layer_api.py`?**
