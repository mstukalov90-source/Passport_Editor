if (L && L.drawLocal) {
        ...
        function toEditableFeatureCollection(geojsonObject) {
            ...
            const features = [];
            const sourceFeatures = normalized.type === 'Feature'
                ? [normalized]
                : (Array.isArray(normalized.features) ? normalized.features : []);
        ...
        function buildObjectPopup(properties, fallbackRootid = '-', fallbackName = '-') {
