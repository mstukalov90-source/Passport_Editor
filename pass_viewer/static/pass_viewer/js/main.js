...
function buildEditableDeletePopupHtml(baseHtml) {
        ...
        const selectedName = cfg.selectedName || "";
        const selectedRequestId = cfg.selectedRequestId || "";
        const selectedRowCtid = cfg.selectedRowCtid || "";
        const effectiveEntryRequestId = cfg.effectiveRequestId || "";
        const selectedCustomerLegalPersonId = cfg.selectedCustomerLegalPersonId || "";
        const selectedDepartmentLegalPersonId = cfg.selectedDepartmentLegalPersonId || "";
        const selectedCustomerLegalPersonName = cfg.selectedCustomerLegalPersonName || "";
        const selectedDepartmentLegalPersonName = cfg.selectedDepartmentLegalPersonName || "";
        const selectedStartdate = cfg.selectedStartdate || "";
        const selectedDatesurvey = cfg.selectedDatesurvey || "";
        const selectedCreatetype = cfg.selectedCreatetype || "";
        ...
        async function repairPolygonFromSaveModal() {
            ...
            try {
                ...
                const stillInvalid =
                    ...
                    mps.validateMultipolygonTargetGeometry(geometryAfterFix, selectedSourceLabel);
                saveModalErrorEl.textContent = '';
                if (stillInvalid) {
