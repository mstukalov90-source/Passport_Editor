...
def map_deferred_layer_specs():
    return [
        ...
        {"key": "dgi_moscow_rent", "label": "г. Москва с арендой"},
        {"key": "dgi_moscow_no_rent", "label": "З/У г. Москва без аренды"},
        {"key": "dgi_private_rent", "label": "Частная или федеральная собственность с арендой"},
        {"key": "dgi_private_no_rent", "label": "Частная или федеральная собственность без аренды"},
        {"key": "dgi_renovation", "label": "Реновация"},
        {"key": "odh", "label": "ОДХ"},
        {"key": "ozn", "label": "ОЗН"},
