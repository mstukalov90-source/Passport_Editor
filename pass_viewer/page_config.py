...
def map_deferred_layer_specs():
    return [
        ...
        {"key": "dgi_moscow_rent", "label": "ДГИ (г. Москва и Н/Д) с арендой"},
        {"key": "dgi_moscow_no_rent", "label": "ДГИ (г. Москва и Н/Д) без аренды"},
        {"key": "dgi_private_rent", "label": "ДГИ (Частная собственность) с арендой"},
        {"key": "dgi_private_no_rent", "label": "ДГИ (Частная собственность) без аренды"},
        {"key": "odh", "label": "ОДХ"},
        {"key": "ozn", "label": "ОЗН"},
