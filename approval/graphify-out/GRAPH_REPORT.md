...
## Corpus Check
- 36 files · ~640,237 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 506 nodes · 1473 edges · 26 communities (17 shown, 9 thin omitted)
...
7. `landing()` - 17 edges
8. `mapApi()` - 16 edges
9. `load_manifest()` - 14 edges
10. `_actor_context()` - 13 edges
...
- `_case_or_error()` --calls--> `user_can_access_case()`  [EXTRACTED]
  GeoDjango/approval/qgis_api_views.py → GeoDjango/approval/access.py
...
Cohesion: 0.06
Nodes (85): get_accessible_approve(), get_accessible_approves(), get_owner_id_for_username(), Access control for approval workflows., build_map_layer_load_order(), Progressive map layer loading for the approval landing page., Ordered specs for sequential client-side loading., Return GeoJSON features for one progressive load chunk. (+77 more)
...
Cohesion: 0.07
Nodes (64): Any, BaseCommand, Element, Command, Match, build_manifest(), build_svg_index(), _collect_svg_references() (+56 more)

### Community 3 - "events_service.py"
Cohesion: 0.07
Nodes (84): is_inspector_for_approve(), _normalized_participant_logins(), user_can_access_case(), _actor_context(), api_add_case_participant(), api_approve_case(), api_bootstrap(), api_case_detail() (+76 more)
...
Cohesion: 0.26
Nodes (12): fitTaskGuidBounds(), fitVisibleBounds(), hideDbLoadingModal(), initLayerPanelControls(), initMap(), loadDeferredMapLayers(), refreshMapUnitMarkers(), reorderMapLayers() (+4 more)
