...
<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" maxScale="0" symbologyReferenceScale="-1" readOnly="0" version="3.44.1-Solothurn" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" autoRefreshTime="0" simplifyLocal="1" simplifyMaxScale="1" autoRefreshMode="Disabled" minScale="100000000" simplifyDrawingTol="1">
  ...
  <elevation showMarkerSymbolInSurfacePlots="0" binding="Centroid" respectLayerSymbol="1" zoffset="0" type="IndividualFeatures" customToleranceEnabled="1" zscale="1" extrusionEnabled="0" extrusion="0" symbology="Line" clamping="Terrain">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="line" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleLine" enabled="1" id="{c1bf3837-da01-4556-a68e-55c9d3ba7329}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{56016f21-0ee9-41d7-803d-24e6865bdc42}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="marker" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleMarker" enabled="1" id="{b4eb3e7b-a92d-4a7f-b4fe-40ecfca9dafd}" locked="0" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" referencescale="-1" symbollevels="0">
    <rules key="{3e3d46d7-f94b-45d0-898d-2f14532794d7}">
      <rule checkstate="0" key="{42a678b9-79f6-404a-8261-2ff2543759e0}" label="Вершины" symbol="0" filter="&quot;fid&quot; is not null"/>
      <rule key="{9e302a16-5138-4b41-a1ec-416b8b832042}" label="Пандус" symbol="1" filter=" &quot;ArrangeElementType&quot; = 'ramp'"/>
      <rule key="{d18a810b-cebb-402a-b79b-c2d24f543809}" label="Перила (поручни)" symbol="2" filter=" &quot;ArrangeElementType&quot; = 'railing_handrails'"/>
      <rule key="{596a112a-3a59-4ece-a87f-0b6b562a5e08}" label="Подъемное устройство" symbol="3" filter=" &quot;ArrangeElementType&quot; = 'lifting_device'"/>
      <rule key="{c2c796b3-fa49-40c3-b986-17bdb092dd6f}" label="Съезд с тротуара на проезжую часть с понижением высоты бортового камня" symbol="4" filter=" &quot;ArrangeElementType&quot; = 'exit_from_the_sidewalk_to_the_roadway'"/>
      <rule key="{e9315da2-ba70-4cf0-8329-d65421ccdbc0}" label="Нет данных" symbol="5" filter=" &quot;ArrangeElementType&quot; is NULL"/>
    </rules>
    <symbols>
      ...
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="5" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{020d6303-575e-4fba-9af6-baa253922166}" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="248,0,4,255,rgb:0.972549,0,0.0156863,1"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="LayerSource" value="dbname='mggt_asu' host=localhost port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;ArrangeElementType&quot;"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="Key" value="Code"/>
            <Option type="QString" name="Layer" value="_____________________________449c4423_7aa3_4217_a2a2_06f90f6cf2bb"/>
            <Option type="QString" name="LayerName" value="Справочник (ДТ/ОО/ОДХ) Единицы измерения"/>
            <Option type="QString" name="LayerProviderName" value="postgres"/>
            <Option type="QString" name="LayerSource" value="dbname='mggt_asu' host=192.168.1.34 port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;Units&quot;"/>
            <Option type="int" name="NofColumns" value="1"/>
