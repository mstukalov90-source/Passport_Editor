...
<qgis maxScale="0" simplifyLocal="1" version="3.38.0-Grenoble" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyAlgorithm="0" minScale="100000000" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" symbologyReferenceScale="-1" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Rendering">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer" referencescale="-1">
    <rules key="{7c7a7e66-5fb9-43de-b46f-e073aa63e370}">
      <rule filter=" &quot;ArrangeElementType&quot; = 'ramp'" symbol="0" key="{6905ce73-4e36-41e7-894d-f1b4d7f2a3ec}" label="Пандус"/>
      <rule filter=" &quot;ArrangeElementType&quot; = 'railing_handrails'" symbol="1" key="{b66e290d-2c88-44b3-abeb-78db2d3cd7ce}" label="Перила (поручни)"/>
      <rule filter=" &quot;ArrangeElementType&quot; = 'lifting_device'" symbol="2" key="{2fcb397f-8b80-4b7e-9f23-beb087bb3711}" label="Подъемное устройство"/>
      <rule filter=" &quot;ArrangeElementType&quot; = 'exit_from_the_sidewalk_to_the_roadway'" symbol="3" key="{e4fd9800-27d1-401b-ac14-1b5e7469d8d3}" label="Съезд с тротуара на проезжую часть с понижением высоты бортового камня"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="FilterExpression" value=" &quot;OghObjectType&quot; = 33" type="QString"/>
