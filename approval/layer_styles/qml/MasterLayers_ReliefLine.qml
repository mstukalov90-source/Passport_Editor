...
<qgis maxScale="0" simplifyLocal="1" version="3.38.0-Grenoble" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyAlgorithm="0" minScale="100000000" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" symbologyReferenceScale="-1" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Rendering">
  <flags>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer" referencescale="-1">
    <rules key="{7c7a7e66-5fb9-43de-b46f-e073aa63e370}">
      <rule filter=" &quot;ArrangeElementType&quot; = 'gabion'" symbol="0" key="{6905ce73-4e36-41e7-894d-f1b4d7f2a3ec}" label="Габион"/>
      <rule filter=" &quot;ArrangeElementType&quot; = 'pedestrian_stairs'" symbol="1" key="{b66e290d-2c88-44b3-abeb-78db2d3cd7ce}" label="Лестница"/>
      <rule filter=" &quot;ArrangeElementType&quot; = 'retaining_walls'" symbol="2" key="{2fcb397f-8b80-4b7e-9f23-beb087bb3711}" label="Подпорные стены"/>
      <rule filter=" &quot;ArrangeElementType&quot; = 'slope_reinforcement_systems'" symbol="3" key="{e4fd9800-27d1-401b-ac14-1b5e7469d8d3}" label="Системы укрепления откосов"/>
      <rule filter="ELSE" symbol="4" key="{89273bcd-a018-4d90-9937-3e0dbbd33dba}"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" name="0" frame_rate="10" type="line" alpha="0.3" clip_to_extent="1" is_animated="0">
        ...
        <layer locked="0" id="{7a0a091e-6547-4842-9a4c-5edc855808fb}" pass="0" class="SimpleLine" enabled="1">
          <Option type="Map">
            ...
            <Option name="line_color" value="8,152,1,255,rgb:0.03137254901960784,0.59607843137254901,0.00392156862745098,1" type="QString"/>
      ...
      <symbol force_rhr="0" name="1" frame_rate="10" type="line" alpha="0.3" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="2" frame_rate="10" type="line" alpha="0.3" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="3" frame_rate="10" type="line" alpha="0.3" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="4" frame_rate="10" type="line" alpha="0.3" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" name="" frame_rate="10" type="line" alpha="1" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{19ee3523-f82c-44ab-a171-94593491343c}" pass="0" class="SimpleLine" enabled="1">
          <Option type="Map">
            <Option name="align_dash_pattern" value="0" type="QString"/>
            <Option name="capstyle" value="square" type="QString"/>
            <Option name="customdash" value="5;2" type="QString"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="FilterExpression" value=" &quot;OghObjectType&quot; = 34" type="QString"/>
            <Option name="Key" value="Code" type="QString"/>
            <Option name="Layer" value="______________________________________e41980e0_567f_40ff_92d9_54aab75795ba" type="QString"/>
            <Option name="LayerName" value="Справочник (ДТ/ОО) Типы элементов организации" type="QString"/>
            <Option name="LayerProviderName" value="postgres" type="QString"/>
            <Option name="LayerSource" value="dbname='mggt_asu' host=192.168.1.34 port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;ArrangeElementType&quot;" type="QString"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="Key" value="Code" type="QString"/>
            <Option name="Layer" value="_____________________________449c4423_7aa3_4217_a2a2_06f90f6cf2bb" type="QString"/>
            <Option name="LayerName" value="Справочник (ДТ/ОО/ОДХ) Единицы измерения" type="QString"/>
            <Option name="LayerProviderName" value="postgres" type="QString"/>
            <Option name="LayerSource" value="dbname='mggt_asu' host=192.168.1.34 port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;Units&quot;" type="QString"/>
            <Option name="NofColumns" value="1" type="int"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="FilterExpression" type="invalid"/>
            <Option name="Key" value="Code" type="QString"/>
            <Option name="Layer" value="_____________________f08d090b_4832_4952_a168_4a0f4a7dad56" type="QString"/>
            <Option name="LayerName" value="Справочник (ДТ/ОО/ОДХ) Материалы" type="QString"/>
            <Option name="LayerProviderName" value="postgres" type="QString"/>
            <Option name="LayerSource" value="dbname='mggt_asu' host=192.168.1.34 port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;Material&quot;" type="QString"/>
            <Option name="NofColumns" value="1" type="int"/>
            <Option name="OrderByValue" value="true" type="bool"/>
            <Option name="UseCompleter" value="false" type="bool"/>
            <Option name="Value" value="Name" type="QString"/>
  ...
  <aliases>
    ...
    <alias index="20" name="" field="CoatingGroup"/>
    <alias index="21" name="" field="CoatingType"/>
    <alias index="22" name="" field="CoatingFaceType"/>
    <alias index="23" name="" field="FaceArea"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="ArrangeElementType"/>
    <policy policy="Duplicate" field="Quantity"/>
    <policy policy="Duplicate" field="Unit"/>
    <policy policy="Duplicate" field="Material"/>
    <policy policy="Duplicate" field="ZoneOghObjectType"/>
    <policy policy="Duplicate" field="ZoneOghObjectRootId"/>
    ...
    <policy policy="Duplicate" field="CoatingFaceType"/>
    <policy policy="Duplicate" field="FaceArea"/>
  </splitPolicies>
  <duplicatePolicies>
    <policy policy="Duplicate" field="fid"/>
    <policy policy="Duplicate" field="OghObjectType"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="ArrangeElementType"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="Quantity"/>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="ZoneOghObjectType"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="ZoneOghObjectRootId"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="FileList"/>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="CoatingGroup"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="CoatingType"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="CoatingFaceType"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="FaceArea"/>
  </constraints>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer showLabel="1" name="Параметры" horizontalStretch="0" collapsed="0" collapsedExpressionEnabled="0" columnCount="6" visibilityExpression="" groupBox="1" type="GroupBox" visibilityExpressionEnabled="0" verticalStretch="0" collapsedExpression="">
      ...
      <attributeEditorField showLabel="1" index="6" name="ArrangeElementType" horizontalStretch="0" verticalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" style="" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField showLabel="1" index="9" name="Material" horizontalStretch="0" verticalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" style="" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField showLabel="1" index="8" name="Unit" horizontalStretch="0" verticalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" style="" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField showLabel="1" index="7" name="Quantity" horizontalStretch="0" verticalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" strikethrough="0" style="" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField showLabel="1" index="13" name="NoCalc" horizontalStretch="0" verticalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" strikethrough="0" style="" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField showLabel="1" index="14" name="IsDiffHeightMark" horizontalStretch="0" verticalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" strikethrough="0" style="" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
