...
<qgis styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Rendering" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="0" version="3.38.0-Grenoble" labelsEnabled="0" symbologyReferenceScale="-1" maxScale="0" simplifyLocal="1" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="0">
  <flags>
  ...
  <renderer-v2 type="singleSymbol" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <symbols>
      <symbol alpha="0.3" type="marker" clip_to_extent="1" name="0" frame_rate="10" is_animated="0" force_rhr="0">
        ...
        <layer id="{44a6f3e9-801b-4300-b075-4bf00567d3f0}" class="SimpleMarker" pass="0" locked="0" enabled="1">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" type="marker" clip_to_extent="1" name="" frame_rate="10" is_animated="0" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer id="{ea7f245f-8f4a-48f8-8508-f4cd20a3ab1c}" class="SimpleMarker" pass="0" locked="0" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
  ...
  <fieldConfiguration>
    ...
    <field name="EquipmentType" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="Endwise" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="MountingMode" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="TrafficSignsCode" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="TrafficSignsName" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="9" field="Endwise"/>
    <alias name="" index="10" field="MountingMode"/>
    <alias name="" index="11" field="TrafficSignsCode"/>
    <alias name="" index="12" field="TrafficSignsName"/>
    <alias name="" index="13" field="Area"/>
    <alias name="" index="14" field="Height"/>
    <alias name="" index="15" field="Placement"/>
  ...
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="EquipmentType"/>
    <policy policy="Duplicate" field="OdhSide"/>
    <policy policy="Duplicate" field="OdhAxis"/>
    <policy policy="Duplicate" field="Endwise"/>
    <policy policy="Duplicate" field="MountingMode"/>
    <policy policy="Duplicate" field="TrafficSignsCode"/>
    <policy policy="Duplicate" field="TrafficSignsName"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="EquipmentType"/>
    <default expression="" applyOnUpdate="0" field="OdhSide"/>
    <default expression="" applyOnUpdate="0" field="OdhAxis"/>
    <default expression="" applyOnUpdate="0" field="Endwise"/>
    <default expression="" applyOnUpdate="0" field="MountingMode"/>
    <default expression="" applyOnUpdate="0" field="TrafficSignsCode"/>
    <default expression="" applyOnUpdate="0" field="TrafficSignsName"/>
    <default expression="" applyOnUpdate="0" field="Area"/>
    <default expression="" applyOnUpdate="0" field="Height"/>
    <default expression="" applyOnUpdate="0" field="Placement"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="OghObjectType" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="ObjectId" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="RootId" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="StartDate" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="EndDate" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="EquipmentType" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="OdhSide" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="OdhAxis" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="Endwise" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="MountingMode" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="TrafficSignsCode" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="TrafficSignsName" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="Area" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="Height" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    ...
    <constraint constraints="0" field="ParentOghObjectType" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="ParentObjectId" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="ParentRootId" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="ParentStartDate" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="ParentEndDate" notnull_strength="0" exp_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" field="Endwise" exp=""/>
    <constraint desc="" field="MountingMode" exp=""/>
    <constraint desc="" field="TrafficSignsCode" exp=""/>
    <constraint desc="" field="TrafficSignsName" exp=""/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field name="Endwise" labelOnTop="0"/>
    <field name="EquipmentType" labelOnTop="0"/>
    <field name="Height" labelOnTop="0"/>
    <field name="MountingMode" labelOnTop="0"/>
    ...
    <field name="TrafficSignsCode" labelOnTop="0"/>
    <field name="TrafficSignsName" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="Endwise" reuseLastValue="0"/>
    <field name="EquipmentType" reuseLastValue="0"/>
    <field name="Height" reuseLastValue="0"/>
    <field name="MountingMode" reuseLastValue="0"/>
    ...
    <field name="TrafficSignsCode" reuseLastValue="0"/>
    <field name="TrafficSignsName" reuseLastValue="0"/>
    <field name="fid" reuseLastValue="0"/>
  </reuseLastValue>
  <dataDefinedFieldProperties/>
  <widgets/>
  <previewExpression>"TrafficSignsName"</previewExpression>
