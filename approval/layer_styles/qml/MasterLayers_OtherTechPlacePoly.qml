...
<qgis version="3.38.0-Grenoble" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" minScale="100000000" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Rendering" simplifyAlgorithm="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" maxScale="0" simplifyDrawingHints="1" readOnly="0">
  ...
  <renderer-v2 forceraster="0" type="singleSymbol" symbollevels="0" enableorderby="0" referencescale="-1">
    <symbols>
      <symbol name="0" type="fill" alpha="0.3" clip_to_extent="1" frame_rate="10" is_animated="0" force_rhr="0">
        ...
        <layer enabled="1" pass="0" class="SimpleFill" id="{d838384d-fb70-45e5-b155-774ba6488c7b}" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="255,190,159,255,rgb:1,0.74509803921568629,0.62352941176470589,1"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" type="fill" alpha="1" clip_to_extent="1" frame_rate="10" is_animated="0" force_rhr="0">
        ...
        <layer enabled="1" pass="0" class="SimpleFill" id="{d5cfccd8-c202-4732-bb86-ec27f29af71a}" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="Layer" type="QString" value="__________________________________________87201f49_f472_45a5_9463_5ceca532118a"/>
            ...
            <Option name="LayerSource" type="QString" value="dbname='mggt_asu' host=192.168.1.34 port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;BuildingsType&quot;"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="AllowNull" type="bool" value="true"/>
            <Option name="Description" type="invalid"/>
            <Option name="FilterExpression" type="QString" value="&quot;BuildingsType&quot; = current_value('BuildingsType')"/>
            <Option name="Key" type="QString" value="Code"/>
            <Option name="Layer" type="QString" value="____________________________________________________a0601b16_78d7_4284_88ef_6eea20538ef8"/>
            <Option name="LayerName" type="QString" value="Справочник (ДТ/ОО) Уточнение назначения зданий и сооружений"/>
            <Option name="LayerProviderName" type="QString" value="postgres"/>
            <Option name="LayerSource" type="QString" value="dbname='mggt_asu' host=192.168.1.34 port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;BuildingsTypeSpec&quot;"/>
            <Option name="NofColumns" type="int" value="1"/>
            <Option name="OrderByValue" type="bool" value="false"/>
            <Option name="UseCompleter" type="bool" value="false"/>
            <Option name="Value" type="QString" value="Name"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="FilterExpression" type="invalid"/>
            <Option name="Key" type="QString" value="Code"/>
            <Option name="Layer" type="QString" value="_____________________ed21a095_f56b_4a66_943b_d59c7c753053"/>
            <Option name="LayerName" type="QString" value="Справочник (ДТ/ОО/ОДХ) Материалы"/>
            <Option name="LayerProviderName" type="QString" value="postgres"/>
            <Option name="LayerSource" type="QString" value="dbname='mggt_asu' host=192.168.1.34 port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;Material&quot;"/>
            <Option name="NofColumns" type="int" value="1"/>
            <Option name="OrderByValue" type="bool" value="false"/>
            <Option name="UseCompleter" type="bool" value="false"/>
            <Option name="Value" type="QString" value="Name"/>
  ...
  <aliases>
    ...
    <alias name="Площадь" field="Area" index="9"/>
    <alias name="" field="AbutmentTypeList" index="10"/>
    <alias name="UNOM" field="Unom" index="11"/>
    <alias name="UNAD" field="Unad" index="12"/>
    <alias name="" field="FileList" index="13"/>
    <alias name="Не учитывать" field="NoCalc" index="14"/>
    <alias name="Разновысотные отметки" field="IsDiffHeightMark" index="15"/>
    <alias name="" field="ParentOghObjectType" index="16"/>
    <alias name="" field="ParentObjectId" index="17"/>
    <alias name="" field="ParentRootId" index="18"/>
    <alias name="" field="ParentStartDate" index="19"/>
    <alias name="" field="ParentEndDate" index="20"/>
  </aliases>
  <splitPolicies>
    ...
    <policy field="BuildingsTypeSpec" policy="Duplicate"/>
  ...
  <defaults>
    ...
    <default field="BuildingsTypeSpec" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="BuildingsTypeSpec" notnull_strength="0" constraints="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="BuildingsTypeSpec" exp="" desc=""/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="Назначение" visibilityExpressionEnabled="0" type="GroupBox" showLabel="1" verticalStretch="0" groupBox="1" collapsedExpression="" horizontalStretch="0" collapsedExpressionEnabled="0" visibilityExpression="" columnCount="3" collapsed="0">
      ...
      <attributeEditorField name="BuildingsTypeSpec" showLabel="1" verticalStretch="0" index="7" horizontalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont underline="0" bold="0" italic="0" strikethrough="0" style="" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="Material" showLabel="1" verticalStretch="0" index="8" horizontalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont underline="0" bold="0" italic="0" strikethrough="0" style="" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer name="Параметры" visibilityExpressionEnabled="0" type="GroupBox" showLabel="1" verticalStretch="0" groupBox="1" collapsedExpression="" horizontalStretch="0" collapsedExpressionEnabled="0" visibilityExpression="" columnCount="5" collapsed="0">
      ...
      <attributeEditorField name="Unom" showLabel="1" verticalStretch="0" index="11" horizontalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont underline="0" bold="0" italic="0" strikethrough="0" style="" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="Unad" showLabel="1" verticalStretch="0" index="12" horizontalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont underline="0" bold="0" italic="0" strikethrough="0" style="" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="Area" showLabel="1" verticalStretch="0" index="9" horizontalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont underline="0" bold="0" italic="0" strikethrough="0" style="" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="NoCalc" showLabel="1" verticalStretch="0" index="14" horizontalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont underline="0" bold="0" italic="0" strikethrough="0" style="" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="IsDiffHeightMark" showLabel="1" verticalStretch="0" index="15" horizontalStretch="0">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
          <labelFont underline="0" bold="0" italic="0" strikethrough="0" style="" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0"/>
        </labelStyle>
      </attributeEditorField>
