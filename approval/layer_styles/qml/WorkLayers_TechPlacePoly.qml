...
<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" maxScale="0" symbologyReferenceScale="-1" readOnly="0" version="3.44.1-Solothurn" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" autoRefreshTime="0" simplifyLocal="1" simplifyMaxScale="1" autoRefreshMode="Disabled" minScale="100000000" simplifyDrawingTol="1">
  ...
  <temporal limitMode="0" mode="0" durationField="fid" enabled="0" startField="StartDate" durationUnit="min" startExpression="" endField="" accumulate="0" endExpression="" fixedDuration="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <elevation showMarkerSymbolInSurfacePlots="0" binding="Centroid" respectLayerSymbol="1" zoffset="0" type="IndividualFeatures" customToleranceEnabled="1" zscale="1" extrusionEnabled="0" extrusion="0" symbology="Line" clamping="Terrain">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="line" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleLine" enabled="1" id="{9fa4f6c3-1cab-4bbc-a882-85ea2abcd7fa}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{ca6466e5-638e-45dd-81fb-aa5079477699}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="marker" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleMarker" enabled="1" id="{b66bb59d-57be-4da1-83fb-f280968b8bb7}" locked="0" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" referencescale="-1" symbollevels="0">
    <rules key="{e459be7a-8df8-4940-b941-8c0369f2d499}">
      <rule checkstate="0" key="{de771220-d193-4c06-84e6-dade8f56a0df}" label="Вершины" symbol="0" filter="&quot;BikeRefType&quot; is not NULL"/>
      <rule key="{0e175494-c29b-431b-8abc-3f34f14184e7}" label="Открытого типа" symbol="1" filter="&quot;BikeRefType&quot; = 'opened'"/>
      <rule key="{37c9ff67-d1d3-4801-89ae-493b9a00d999}" label="Закрытого типа" symbol="2" filter="&quot;BikeRefType&quot; = 'closed'"/>
      <rule key="{60b9c02e-b0b8-4dca-b69e-efd42f4acb29}" label="Нет данных" symbol="3" filter="ELSE"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias name="" field="BuildingsType" index="6"/>
    <alias name="Материал" field="Material" index="7"/>
    <alias name="Площадь, кв.м." field="Area" index="8"/>
    ...
    <alias name="" field="CreateDate" index="20"/>
    <alias name="" field="CreateAuthor" index="21"/>
    <alias name="" field="ChangeDate" index="22"/>
    <alias name="" field="ChangeAuthor" index="23"/>
    <alias name="" field="TaskGUID" index="24"/>
  </aliases>
  <defaults>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer verticalStretch="0" collapsedExpression="" collapsedExpressionEnabled="0" type="GroupBox" name="Назначение" columnCount="5" collapsed="0" groupBox="1" visibilityExpression="" showLabel="1" horizontalStretch="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField verticalStretch="0" name="BikeParkType" index="-1" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="BikeRefType" index="-1" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="Material" index="7" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="CoatingGroup" index="-1" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="CoatingType" index="-1" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer verticalStretch="0" collapsedExpression="" collapsedExpressionEnabled="0" type="GroupBox" name="Параметры" columnCount="5" collapsed="0" groupBox="1" visibilityExpression="" showLabel="1" horizontalStretch="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField verticalStretch="0" name="Unom" index="10" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="Unad" index="11" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="Area" index="8" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="NoCalc" index="13" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="IsDiffHeightMark" index="14" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field name="BuildingsType" labelOnTop="0"/>
