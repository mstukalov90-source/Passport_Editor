...
<qgis version="3.44.1-Solothurn" simplifyDrawingHints="1" simplifyAlgorithm="0" autoRefreshTime="0" autoRefreshMode="Disabled" hasScaleBasedVisibilityFlag="0" minScale="100000000" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="Symbology|Labeling|Fields|Forms|MapTips|Rendering|GeometryOptions" maxScale="0" simplifyLocal="1">
  <renderer-v2 referencescale="-1" enableorderby="0" symbollevels="1" type="RuleRenderer" forceraster="0">
    ...
    <symbols>
      ...
      <symbol is_animated="0" frame_rate="10" force_rhr="0" type="line" name="2" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
                ...
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    ...
                    <Option type="Map" name="char">
                      <Option value="true" type="bool" name="active"/>
                      <Option value="&quot;SignText&quot;" type="QString" name="expression"/>
                      <Option value="3" type="int" name="type"/>
                    </Option>
  ...
  <defaults>
    ...
    <default field="TrafficSignsCode" applyOnUpdate="1" expression="attribute( get_feature('Справочник (ОДХ) Код знака по ГОСТ', 'Name', &quot;TrafficSignsName&quot;), 'Code')"/>
    <default field="TrafficSignsName" applyOnUpdate="1" expression="attribute( get_feature('Справочник (ОДХ) Код знака по ГОСТ', 'Code', &quot;TrafficSignsCode&quot;), 'Name')"/>
    <default field="Area" applyOnUpdate="0" expression="0.35"/>
    ...
    <default field="SvgMarkerPath" applyOnUpdate="1" expression="attribute( get_feature('Параметры дорожных знаков', 'TrafficSignsCode', &quot;TrafficSignsCode&quot;), 'SvgName')"/>
