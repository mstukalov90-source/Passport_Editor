...
<qgis maxScale="0" simplifyLocal="1" version="3.38.0-Grenoble" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyAlgorithm="0" minScale="100000000" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" symbologyReferenceScale="-1" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Rendering">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer" referencescale="-1">
    <rules key="{3e3d46d7-f94b-45d0-898d-2f14532794d7}">
      ...
      <rule filter="ELSE" symbol="4" key="{3f52b3dc-1127-4209-900b-47cbfdf74850}" label="Нет данных"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" name="0" frame_rate="10" type="fill" alpha="0.3" clip_to_extent="1" is_animated="0">
        ...
        <layer locked="0" id="{bd23cc40-2ba2-4171-a111-99041d1a44f4}" pass="0" class="SimpleFill" enabled="1">
          <Option type="Map">
      ...
      <symbol force_rhr="0" name="4" frame_rate="10" type="fill" alpha="0.3" clip_to_extent="1" is_animated="0">
        ...
        <layer locked="0" id="{020d6303-575e-4fba-9af6-baa253922166}" pass="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="color" value="248,0,4,255,rgb:0.97254901960784312,0,0.01568627450980392,1" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="offset" value="0,0" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" name="" frame_rate="10" type="fill" alpha="1" clip_to_extent="1" is_animated="0">
        ...
        <layer locked="0" id="{3adf0822-5907-4484-86b7-8cb016ae8ee8}" pass="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
