...
<qgis simplifyDrawingHints="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" version="3.38.0-Grenoble" simplifyAlgorithm="0" simplifyMaxScale="1" minScale="100000000" symbologyReferenceScale="-1" maxScale="0" styleCategories="Symbology|Labeling|Fields|Forms|MapTips|Rendering|GeometryOptions" simplifyDrawingTol="1">
  <renderer-v2 enableorderby="0" type="singleSymbol" forceraster="0" referencescale="-1" symbollevels="0">
    <symbols>
      <symbol force_rhr="0" frame_rate="10" type="fill" name="0" clip_to_extent="1" is_animated="0" alpha="1">
        ...
        <layer class="SimpleLine" enabled="1" locked="0" id="{55807b6a-bb10-4598-be1b-9802cedb0564}" pass="0">
          <Option type="Map">
            ...
            <Option value="10" type="QString" name="dash_pattern_offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="dash_pattern_offset_map_unit_scale"/>
            <Option value="MapUnit" type="QString" name="dash_pattern_offset_unit"/>
            <Option value="0" type="QString" name="draw_inside_polygon"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="228,26,28,255,rgb:0.89411764705882357,0.10196078431372549,0.10980392156862745,1" type="QString" name="line_color"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" frame_rate="10" type="fill" name="" clip_to_extent="1" is_animated="0" alpha="1">
        ...
        <layer class="SimpleFill" enabled="1" locked="0" id="{c2a24fb3-2572-45e2-85be-11b7012ca1e8}" pass="0">
          <Option type="Map">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="ERRORS">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
    ...
    <field configurationFlags="NoFlag" name="NODE">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="RootId" index="2" name="Идентификатор ОГХ (RootId)"/>
    <alias field="ERRORS" index="3" name=""/>
    <alias field="NODE" index="4" name=""/>
  </aliases>
  <splitPolicies>
    <policy policy="Duplicate" field="fid"/>
    <policy policy="Duplicate" field="ObjectId"/>
    <policy policy="Duplicate" field="RootId"/>
    <policy policy="Duplicate" field="ERRORS"/>
    <policy policy="Duplicate" field="NODE"/>
  </splitPolicies>
  <duplicatePolicies>
    <policy policy="Duplicate" field="fid"/>
    <policy policy="Duplicate" field="ObjectId"/>
  ...
  <defaults>
    ...
    <default field="ERRORS" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="ERRORS" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" field="NODE" exp_strength="0" unique_strength="0" notnull_strength="0"/>
  </constraints>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorAction horizontalStretch="0" verticalStretch="0" ActionUUID="{d0a651a1-e616-4ad1-99ec-6b6052ff4543}" name="{d0a651a1-e616-4ad1-99ec-6b6052ff4543}" showLabel="1">
      <labelStyle labelColor="" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont italic="0" style="" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" bold="0" underline="0"/>
      </labelStyle>
    </attributeEditorAction>
    <attributeEditorField horizontalStretch="0" verticalStretch="0" index="0" name="fid" showLabel="1">
      <labelStyle labelColor="" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont italic="0" style="" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" bold="0" underline="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField horizontalStretch="0" verticalStretch="0" index="2" name="RootId" showLabel="1">
      <labelStyle labelColor="" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont italic="0" style="" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" bold="0" underline="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField horizontalStretch="0" verticalStretch="0" index="1" name="ObjectId" showLabel="1">
      <labelStyle labelColor="" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont italic="0" style="" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" bold="0" underline="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField horizontalStretch="0" verticalStretch="0" index="3" name="ERRORS" showLabel="1">
      <labelStyle labelColor="" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont italic="0" style="" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" bold="0" underline="0"/>
      </labelStyle>
    </attributeEditorField>
  ...
  <labelOnTop>
    <field labelOnTop="0" name="ERRORS"/>
    <field labelOnTop="0" name="NODE"/>
    <field labelOnTop="0" name="ObjectId"/>
    <field labelOnTop="0" name="RootId"/>
    <field labelOnTop="0" name="fid"/>
  </labelOnTop>
  <reuseLastValue>
    <field reuseLastValue="0" name="ERRORS"/>
    <field reuseLastValue="0" name="NODE"/>
