...
<qgis version="3.38.0-Grenoble" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" minScale="100000000" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Rendering" simplifyAlgorithm="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" maxScale="0" simplifyDrawingHints="1" readOnly="0">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0" referencescale="-1">
    <rules key="{3fed4529-3ca7-4b7f-8d52-31734bab58ed}">
      <rule key="{957ddae4-afb8-4a30-b1fb-83d5dac31fc3}" symbol="0" filter="&quot;ContainerType&quot; = 'bunker_area'" label="Бункерная площадка"/>
      <rule key="{8ac04dc0-154d-4c7b-aae8-87581bf92c49}" symbol="1" filter="&quot;ContainerType&quot; = 'container_area'" label="Контейнерная площадка"/>
      <rule key="{74f720f5-20bd-4ebc-85a4-4013498439e3}" symbol="2" filter="&quot;ContainerType&quot; = 'pavilion_rso'" label="Стационарный павильон для РСО"/>
      <rule key="{06eb02e0-9f5a-4c55-9f13-571bdaf847f4}" symbol="3" filter="&quot;ContainerType&quot; = 'roll_container_area'" label="Контейнер для РСО"/>
      <rule key="{df6326b9-17d6-46ac-94a9-1d4de8197762}" symbol="4" filter="&quot;ContainerType&quot; = 'roll_container_useful_components_area'" label="Контейнер для компонентов РСО"/>
      <rule key="{e00b9bfc-8538-4996-aebc-5d20036ecd78}" symbol="5" filter="ELSE" label="Нет данных"/>
    </rules>
    <symbols>
      <symbol name="0" type="fill" alpha="0.3" clip_to_extent="1" frame_rate="10" is_animated="0" force_rhr="0">
        ...
        <layer enabled="1" pass="0" class="SimpleFill" id="{20492a36-a613-419a-8d9d-1c9adf9fcf89}" locked="0">
          <Option type="Map">
      ...
      <symbol name="1" type="fill" alpha="0.3" clip_to_extent="1" frame_rate="10" is_animated="0" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="2" type="fill" alpha="0.3" clip_to_extent="1" frame_rate="10" is_animated="0" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="3" type="fill" alpha="0.3" clip_to_extent="1" frame_rate="10" is_animated="0" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="4" type="fill" alpha="0.3" clip_to_extent="1" frame_rate="10" is_animated="0" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="5" type="fill" alpha="0.3" clip_to_extent="1" frame_rate="10" is_animated="0" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" class="SimpleFill" id="{115ec2a1-1de5-45cf-8df8-c57070d9d905}" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="228,26,28,255,rgb:0.89411764705882357,0.10196078431372549,0.10980392156862745,1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="128,14,16,255,rgb:0.50196078431372548,0.05490196078431372,0.06274509803921569,1"/>
            <Option name="outline_style" type="QString" value="solid"/>
            <Option name="outline_width" type="QString" value="0.26"/>
            <Option name="outline_width_unit" type="QString" value="MM"/>
            <Option name="style" type="QString" value="solid"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" type="fill" alpha="1" clip_to_extent="1" frame_rate="10" is_animated="0" force_rhr="0">
        ...
        <layer enabled="1" pass="0" class="SimpleFill" id="{9a2c19a4-32a2-40a3-8fa7-545cc45c05f0}" locked="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
