...
<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" maxScale="0" symbologyReferenceScale="-1" readOnly="0" version="3.44.1-Solothurn" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" autoRefreshTime="0" simplifyLocal="1" simplifyMaxScale="1" autoRefreshMode="Disabled" minScale="100000000" simplifyDrawingTol="1">
  ...
  <elevation showMarkerSymbolInSurfacePlots="0" binding="Centroid" respectLayerSymbol="1" zoffset="0" type="IndividualFeatures" customToleranceEnabled="1" zscale="1" extrusionEnabled="0" extrusion="0" symbology="Line" clamping="Terrain">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="line" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleLine" enabled="1" id="{d4042a2e-360d-4e50-85c7-bdb969594c69}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="145,82,45,255,rgb:0.5686275,0.3215686,0.1764706,1"/>
    ...
    <profileFillSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{118a3a82-16db-455b-8b60-51284c81b49f}" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="145,82,45,255,rgb:0.5686275,0.3215686,0.1764706,1"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="104,59,32,255,rgb:0.4061494,0.2296788,0.1260395,1"/>
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="marker" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleMarker" enabled="1" id="{bd2c0112-ca35-4bc8-a52d-0eca3b635fff}" locked="0" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" referencescale="-1" symbollevels="0">
    <rules key="{e2221186-27c3-4f91-a9e9-be7691cfab69}">
      <rule checkstate="0" key="{0e4a5fc2-f996-4ac5-940b-3add53af97ff}" label="Вершины" symbol="0" filter=" &quot;ArrangeElementType&quot; is not  NULL"/>
      <rule key="{1a42831d-57b7-4804-aa5a-7943b65731a2}" label="Шахта вентиляционной камеры" symbol="1" filter=" &quot;ArrangeElementType&quot; = 'ventilation_chamber_shaft'"/>
      <rule key="{cc94e6d0-22e4-480b-9fa2-4b7e145d6cb3}" label="Лоток водосточный" symbol="2" filter=" &quot;ArrangeElementType&quot; in ('gutter_tray', 'gutter_trays')"/>
      <rule key="{54fefcff-922d-4601-a94e-58ec856fed22}" label="Лоток водосточный без решетки" symbol="3" filter=" &quot;ArrangeElementType&quot; = 'gutter_tray_wo'"/>
      <rule key="{bdf465ea-385a-44b6-8cd5-8cac82f5a341}" label="Желоб ливневой" symbol="4" filter=" &quot;ArrangeElementType&quot; = 'gutter'"/>
      <rule key="{d4bd9439-8bc3-45b0-a337-70e7102539d1}" label="Нет данных" symbol="5" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="1" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{bd23cc40-2ba2-4171-a111-99041d1a44f4}" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      ...
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="2" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{bd23cc40-2ba2-4171-a111-99041d1a44f4}" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="89,212,212,255,hsv:0.5,0.58031586175326166,0.82969405661097129,1"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
      ...
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="5" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
        ...
        <layer class="SimpleFill" enabled="1" id="{bd23cc40-2ba2-4171-a111-99041d1a44f4}" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="218,0,4,255,hsv:0.99722222222222223,1,0.85490196078431369,1"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{3adf0822-5907-4484-86b7-8cb016ae8ee8}" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="FilterExpression" value=" &quot;OghObjectType&quot; = 35 and &quot;AllowedPoly&quot; and &#xa;CASE &#xa;&#x9;WHEN @MggtAsuTaskType=1 THEN &quot;AllowedInDT&quot; &#xa;&#x9;WHEN @MggtAsuTaskType=3 THEN &quot;AllowedInOO&quot;&#xa;&#x9;WHEN @MggtAsuTaskType=4 THEN &quot;AllowedInTOP&quot; &#xa;&#x9;ELSE False&#xa;END"/>
            <Option type="invalid" name="Group"/>
            <Option type="QString" name="Key" value="Code"/>
            <Option type="QString" name="Layer" value="______________________________________________53d37648_ce55_467f_bb3b_72b63595b7f3"/>
            <Option type="QString" name="LayerName" value="Справочник (ДТ/ОО) Типы элементов организации"/>
            <Option type="QString" name="LayerProviderName" value="postgres"/>
            <Option type="QString" name="LayerSource" value="dbname='mggt_asu' host=localhost port=5432 user='postgres' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;ArrangeElementType&quot;"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="invalid" name="Group"/>
            <Option type="QString" name="Key" value="Code"/>
            <Option type="QString" name="Layer" value="_____________________________c6b74e4b_381c_40b0_9511_82f08dd91449"/>
            <Option type="QString" name="LayerName" value="Справочник (ДТ/ОО/ОДХ) Единицы измерения"/>
            <Option type="QString" name="LayerProviderName" value="postgres"/>
            <Option type="QString" name="LayerSource" value="dbname='mggt_asu' host=localhost port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;Units&quot;"/>
            <Option type="int" name="NofColumns" value="1"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="invalid" name="Group"/>
            <Option type="QString" name="Key" value="Code"/>
            <Option type="QString" name="Layer" value="_____________________81798418_16c1_41a5_9876_252bd71c3359"/>
  ...
  <aliases>
    ...
    <alias name="Единица измерения" field="Unit" index="8"/>
    <alias name="Материал" field="Material" index="9"/>
    <alias name="" field="CoatingFaceType" index="10"/>
    <alias name="" field="FaceArea" index="11"/>
    <alias name="" field="ZoneOghObjectType" index="12"/>
    <alias name="" field="ZoneOghObjectRootId" index="13"/>
    <alias name="" field="FileList" index="14"/>
    <alias name="Не учитывать" field="NoCalc" index="15"/>
    <alias name="Разновысотные отметки" field="IsDiffHeightMark" index="16"/>
    <alias name="" field="ParentOghObjectType" index="17"/>
    <alias name="" field="ParentObjectId" index="18"/>
    <alias name="" field="ParentRootId" index="19"/>
    <alias name="" field="ParentStartDate" index="20"/>
    <alias name="" field="ParentEndDate" index="21"/>
    <alias name="" field="CreateDate" index="22"/>
    <alias name="" field="CreateAuthor" index="23"/>
    <alias name="" field="ChangeDate" index="24"/>
    <alias name="" field="ChangeAuthor" index="25"/>
    <alias name="" field="TaskGUID" index="26"/>
  </aliases>
  <defaults>
    ...
    <default expression="" field="ArrangeElementType" applyOnUpdate="0"/>
    ...
    <default expression="" field="ZoneOghObjectType" applyOnUpdate="0"/>
    <default expression="" field="ZoneOghObjectRootId" applyOnUpdate="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="ArrangeElementType" desc=""/>
    ...
    <constraint exp="" field="ZoneOghObjectType" desc=""/>
    <constraint exp="" field="ZoneOghObjectRootId" desc=""/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" name="ArrangeElementType" hidden="0" width="-1"/>
      ...
      <column type="field" name="ZoneOghObjectType" hidden="0" width="-1"/>
      <column type="field" name="ZoneOghObjectRootId" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer verticalStretch="0" collapsedExpression="" collapsedExpressionEnabled="0" type="GroupBox" name="Назначение" columnCount="4" collapsed="0" groupBox="1" visibilityExpression="" showLabel="1" horizontalStretch="0" visibilityExpressionEnabled="0">
      ...
      <attributeEditorField verticalStretch="0" name="ArrangeElementType" index="6" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="Quantity" index="7" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="Unit" index="8" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="Material" index="9" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    </attributeEditorContainer>
    <attributeEditorContainer verticalStretch="0" collapsedExpression="" collapsedExpressionEnabled="0" type="GroupBox" name="Параметры" columnCount="2" collapsed="0" groupBox="1" visibilityExpression="" showLabel="1" horizontalStretch="0" visibilityExpressionEnabled="0">
      <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
        <labelFont italic="0" underline="0" description="Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
      </labelStyle>
      <attributeEditorField verticalStretch="0" name="NoCalc" index="15" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="IsDiffHeightMark" index="16" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
