...
<qgis simplifyAlgorithm="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" maxScale="0" symbologyReferenceScale="-1" readOnly="0" version="3.44.1-Solothurn" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" autoRefreshTime="0" simplifyLocal="1" simplifyMaxScale="1" autoRefreshMode="Disabled" minScale="100000000" simplifyDrawingTol="1">
  ...
  <elevation showMarkerSymbolInSurfacePlots="0" binding="Centroid" respectLayerSymbol="1" zoffset="0" type="IndividualFeatures" customToleranceEnabled="1" zscale="1" extrusionEnabled="0" extrusion="0" symbology="Line" clamping="Terrain">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="line" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleLine" enabled="1" id="{d56b8215-b3aa-4a1a-b0cb-48261d45a3f7}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{9b3af629-ed45-46e0-a66a-3ce17701288d}" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="213,180,60,255,rgb:0.8352941,0.7058824,0.2352941,1"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="152,129,43,255,rgb:0.5966278,0.5042039,0.1680629,1"/>
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="marker" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleMarker" enabled="1" id="{df17711e-3975-4833-833a-ec06547af3d6}" locked="0" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" referencescale="-1" symbollevels="0">
    <rules key="{0228dc7b-8774-40ff-b141-55655c124d78}">
      <rule checkstate="0" key="{5ffbcf6a-cbc3-4ecc-80c7-6ecfa365f9de}" label="Вершины" symbol="0" filter="&quot;BuildingsTypeSpec&quot; is not  NULL"/>
      <rule key="{18a6e4fb-8cb2-4858-b447-3ef2e50256f1}" label="Иной объект капитального строительства" symbol="1" filter="&quot;BuildingsTypeSpec&quot; != 'blind_area'"/>
      <rule key="{d6598145-b275-4ac7-af7e-4a198878c64e}" label="Отмостка" symbol="2" filter="&quot;BuildingsTypeSpec&quot; = 'blind_area'"/>
      <rule key="{d9f015cb-c413-49ca-a106-7175f14e080c}" label="Нет данных" symbol="3" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="1" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{bc9c7821-49e3-4ea7-8e49-e7c0b247675e}" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="255,128,128,255,rgb:1,0.5019608,0.5019608,1"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
      ...
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="2" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{9758d3b0-16d1-4c7e-a51e-3c21624aff48}" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="220,220,220,255,rgb:0.8627451,0.8627451,0.8627451,1"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
      ...
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="3" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{115ec2a1-1de5-45cf-8df8-c57070d9d905}" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="228,26,28,255,rgb:0.8941176,0.1019608,0.1098039,1"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="offset" value="0,0"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="128,14,16,255,rgb:0.5019608,0.054902,0.0627451,1"/>
            <Option type="QString" name="outline_style" value="solid"/>
            <Option type="QString" name="outline_width" value="0.26"/>
            <Option type="QString" name="outline_width_unit" value="MM"/>
            <Option type="QString" name="style" value="solid"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" name="" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleFill" enabled="1" id="{8273d055-492e-4ad6-a2fc-299d240d44cf}" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
  ...
  <fieldConfiguration>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="Layer" value="__________________________________________240849be_630f_4264_865e_c0ea109dacf2"/>
            <Option type="QString" name="LayerName" value="Справочник (ДТ/ОО) Назначение зданий и сооружений"/>
            <Option type="QString" name="LayerProviderName" value="postgres"/>
            <Option type="QString" name="LayerSource" value="dbname='mggt_asu' host=localhost port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;BuildingsType&quot;"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="invalid" name="Description"/>
            <Option type="bool" name="DisplayGroupName" value="false"/>
            <Option type="QString" name="FilterExpression" value="&quot;BuildingsType&quot; = current_value('BuildingsType') and  &quot;OghObjectType&quot; =  48 and &#xa;CASE &#xa;&#x9;WHEN @MggtAsuTaskType=1 THEN &quot;AllowedInDT&quot; &#xa;&#x9;WHEN @MggtAsuTaskType=3 THEN &quot;AllowedInOO&quot;&#xa;&#x9;WHEN @MggtAsuTaskType=4 THEN &quot;AllowedInTOP&quot; &#xa;&#x9;ELSE False&#xa;END"/>
            <Option type="invalid" name="Group"/>
            <Option type="QString" name="Key" value="Code"/>
            <Option type="QString" name="Layer" value="____________________________________________________2c306da8_6885_40d2_ad8d_1eb3490675ab"/>
            <Option type="QString" name="LayerName" value="Справочник (ДТ/ОО) Уточнение назначения зданий и сооружений"/>
            <Option type="QString" name="LayerProviderName" value="postgres"/>
            <Option type="QString" name="LayerSource" value="dbname='mggt_asu' host=localhost port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;BuildingsTypeSpec&quot;"/>
            <Option type="int" name="NofColumns" value="1"/>
            <Option type="bool" name="OrderByValue" value="false"/>
            <Option type="bool" name="UseCompleter" value="false"/>
            <Option type="QString" name="Value" value="Name"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="invalid" name="Group"/>
            <Option type="QString" name="Key" value="Code"/>
            <Option type="QString" name="Layer" value="___________________________935709d1_2a82_4f9a_9ca2_810cb45262a5"/>
            <Option type="QString" name="LayerName" value="Справочник (ДТ/ОО/ОДХ) Группы покрытий"/>
            <Option type="QString" name="LayerProviderName" value="postgres"/>
            <Option type="QString" name="LayerSource" value="dbname='mggt_asu' host=localhost port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;CoatingTypeGroup&quot;"/>
            <Option type="int" name="NofColumns" value="1"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="invalid" name="Description"/>
            <Option type="bool" name="DisplayGroupName" value="false"/>
            <Option type="QString" name="FilterExpression" value="&quot;CoatingGroup&quot; = current_value('CoatingGroup') and &#xa;CASE &#xa;&#x9;WHEN @MggtAsuTaskType=1 THEN &quot;AllowedInDT&quot; &#xa;&#x9;WHEN @MggtAsuTaskType=2 THEN &quot;AllowedInODH&quot; &#xa;&#x9;WHEN @MggtAsuTaskType=3 THEN &quot;AllowedInOO&quot;&#xa;&#x9;WHEN @MggtAsuTaskType=4 THEN &quot;AllowedInTOP&quot; &#xa;&#x9;ELSE False&#xa;END"/>
            <Option type="invalid" name="Group"/>
            <Option type="QString" name="Key" value="Code"/>
            <Option type="QString" name="Layer" value="_________________________bef6f20c_2182_4fe7_bc3f_983292dbefb9"/>
            <Option type="QString" name="LayerName" value="Справочник (ДТ/ОО/ОДХ) Виды покрытий"/>
            <Option type="QString" name="LayerProviderName" value="postgres"/>
            <Option type="QString" name="LayerSource" value="dbname='mggt_asu' host=localhost port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;CoatingType&quot;"/>
            <Option type="int" name="NofColumns" value="1"/>
            <Option type="bool" name="OrderByValue" value="true"/>
            <Option type="bool" name="UseCompleter" value="false"/>
            <Option type="QString" name="Value" value="Name"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="invalid" name="Group"/>
            <Option type="QString" name="Key" value="Code"/>
            <Option type="QString" name="Layer" value="_________________________45e84f31_284c_46df_afb4_47d910f51911"/>
            <Option type="QString" name="LayerName" value="Справочник (ДТ/ОО/ОДХ) Виды покрытий"/>
            <Option type="QString" name="LayerProviderName" value="postgres"/>
            <Option type="QString" name="LayerSource" value="dbname='mggt_asu' host=localhost port=5432 user='gisproject' key='fid' checkPrimaryKeyUnicity='1' table=&quot;cls&quot;.&quot;CoatingType&quot;"/>
            <Option type="int" name="NofColumns" value="1"/>
    ...
    <field name="IsSmmCleaning" configurationFlags="NoFlag">
      <editWidget type="CheckBox">
        <config>
          <Option type="Map">
            <Option type="bool" name="AllowNullState" value="false"/>
  ...
  <aliases>
    ...
    <alias name="Уточнение назначения" field="BuildingsTypeSpec" index="7"/>
    <alias name="Характеристика" field="Property" index="8"/>
    <alias name="Площадь, кв.м." field="Area" index="9"/>
    <alias name="Группа покрытия" field="CoatingGroup" index="10"/>
    <alias name="Вид покрытия" field="CoatingType" index="11"/>
    <alias name="Вид покрытия (облицовка)" field="CoatingFaceType" index="12"/>
    <alias name="" field="FaceArea" index="13"/>
    <alias name="UNOM" field="Unom" index="14"/>
    <alias name="UNAD" field="Unad" index="15"/>
    <alias name="" field="FileList" index="16"/>
    <alias name="Не учитывать" field="NoCalc" index="17"/>
    <alias name="Разновысотные отметки" field="IsDiffHeightMark" index="18"/>
    <alias name="" field="ParentOghObjectType" index="19"/>
    <alias name="" field="ParentObjectId" index="20"/>
    <alias name="" field="ParentRootId" index="21"/>
    <alias name="" field="ParentStartDate" index="22"/>
    <alias name="" field="ParentEndDate" index="23"/>
    <alias name="" field="CreateDate" index="24"/>
    <alias name="" field="CreateAuthor" index="25"/>
    <alias name="" field="ChangeDate" index="26"/>
    <alias name="" field="ChangeAuthor" index="27"/>
    <alias name="" field="TaskGUID" index="28"/>
    <alias name="Уборка с применением СММ" field="IsSmmCleaning" index="29"/>
  </aliases>
  <defaults>
    ...
    <default expression="" field="CoatingType" applyOnUpdate="0"/>
    <default expression="" field="CoatingFaceType" applyOnUpdate="0"/>
    <default expression="" field="FaceArea" applyOnUpdate="0"/>
    ...
    <default expression="" field="IsSmmCleaning" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" field="BuildingsType" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" field="BuildingsTypeSpec" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" field="Property" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    ...
    <constraint constraints="0" field="Unom" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" field="Unad" exp_strength="0" unique_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="BuildingsType" desc=""/>
    <constraint exp="" field="BuildingsTypeSpec" desc=""/>
    <constraint exp="" field="Property" desc=""/>
    <constraint exp="" field="Area" desc=""/>
    <constraint exp="" field="CoatingGroup" desc=""/>
    <constraint exp="" field="CoatingType" desc=""/>
    <constraint exp="" field="CoatingFaceType" desc=""/>
    <constraint exp="" field="FaceArea" desc=""/>
    <constraint exp="" field="Unom" desc=""/>
    <constraint exp="" field="Unad" desc=""/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" name="BuildingsType" hidden="0" width="-1"/>
      <column type="field" name="BuildingsTypeSpec" hidden="0" width="-1"/>
      <column type="field" name="Property" hidden="0" width="-1"/>
      <column type="field" name="Area" hidden="0" width="-1"/>
      <column type="field" name="CoatingGroup" hidden="0" width="-1"/>
      <column type="field" name="CoatingType" hidden="0" width="-1"/>
      <column type="field" name="CoatingFaceType" hidden="0" width="-1"/>
      <column type="field" name="FaceArea" hidden="0" width="-1"/>
      <column type="field" name="Unom" hidden="0" width="-1"/>
      <column type="field" name="Unad" hidden="0" width="-1"/>
      <column type="field" name="FileList" hidden="0" width="-1"/>
      <column type="field" name="NoCalc" hidden="0" width="-1"/>
      ...
      <column type="field" name="IsSmmCleaning" hidden="0" width="-1"/>
  ...
  <editforminitfilepath>C:\Users\ashevrygina\AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins\mggtasu\init_functions\file_manager.py</editforminitfilepath>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer verticalStretch="0" collapsedExpression="" collapsedExpressionEnabled="0" type="GroupBox" name="Назначение" columnCount="3" collapsed="0" groupBox="1" visibilityExpression="" showLabel="1" horizontalStretch="0" visibilityExpressionEnabled="0">
      <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
        <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
      </labelStyle>
      <attributeEditorField verticalStretch="0" name="BuildingsType" index="6" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="BuildingsTypeSpec" index="7" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="Property" index="8" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="CoatingGroup" index="10" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="CoatingType" index="11" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="CoatingFaceType" index="12" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    </attributeEditorContainer>
    <attributeEditorContainer verticalStretch="0" collapsedExpression="" collapsedExpressionEnabled="0" type="GroupBox" name="Параметры" columnCount="6" collapsed="0" groupBox="1" visibilityExpression="" showLabel="1" horizontalStretch="0" visibilityExpressionEnabled="0">
      <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
        <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
      </labelStyle>
      <attributeEditorField verticalStretch="0" name="Unom" index="14" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="Unad" index="15" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="Area" index="9" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="NoCalc" index="17" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="IsDiffHeightMark" index="18" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="0,0,0,255,rgb:0,0,0,1" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="Bitstream Vera Sans,10,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" name="IsSmmCleaning" index="29" showLabel="1" horizontalStretch="0">
        <labelStyle labelColor="" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont italic="0" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field name="CoatingFaceType" labelOnTop="1"/>
    ...
    <field name="IsSmmCleaning" labelOnTop="1"/>
  ...
  <reuseLastValue>
    ...
    <field name="IsSmmCleaning" reuseLastValue="0"/>
  ...
  <dataDefinedFieldProperties>
    <field name="IsSmmCleaning">
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option type="Map" name="properties">
          <Option type="Map" name="dataDefinedEditable">
            <Option type="bool" name="active" value="true"/>
            <Option type="QString" name="expression" value="if(&quot;BuildingsType&quot; = 'blind_area' and &quot;BuildingsTypeSpec&quot; = 'blind_area', True, False)"/>
  ...
  <widgets/>
  <previewExpression>"Unom"</previewExpression>
