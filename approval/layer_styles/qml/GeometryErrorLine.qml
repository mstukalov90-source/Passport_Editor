...
<qgis simplifyDrawingHints="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" version="3.38.0-Grenoble" simplifyAlgorithm="0" simplifyMaxScale="1" minScale="100000000" symbologyReferenceScale="-1" maxScale="0" styleCategories="Symbology|Labeling|Fields|Forms|MapTips|Rendering|GeometryOptions" simplifyDrawingTol="1">
  <renderer-v2 enableorderby="0" type="singleSymbol" forceraster="0" referencescale="-1" symbollevels="0">
    <symbols>
      <symbol force_rhr="0" frame_rate="10" type="line" name="0" clip_to_extent="1" is_animated="0" alpha="1">
        ...
        <layer class="SimpleLine" enabled="1" locked="0" id="{96a3edde-bd38-4139-ba8a-574a195e7069}" pass="0">
          <Option type="Map">
            ...
            <Option value="0,46,255,255,rgb:0,0.1803921568627451,1,1" type="QString" name="line_color"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" frame_rate="10" type="line" name="" clip_to_extent="1" is_animated="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer class="SimpleLine" enabled="1" locked="0" id="{9b3cc4cb-f761-434b-bfb4-d04cb5e899ae}" pass="0">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
            <Option value="square" type="QString" name="capstyle"/>
            <Option value="5;2" type="QString" name="customdash"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorAction horizontalStretch="0" verticalStretch="0" ActionUUID="{ee06974b-4e7b-4ca4-a13d-8efd7c66f58e}" name="{ee06974b-4e7b-4ca4-a13d-8efd7c66f58e}" showLabel="1">
      <labelStyle labelColor="" overrideLabelFont="0" overrideLabelColor="0">
        <labelFont italic="0" style="" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" bold="0" underline="0"/>
      </labelStyle>
