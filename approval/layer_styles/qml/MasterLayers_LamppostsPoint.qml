...
<qgis styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Rendering" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="0" version="3.38.0-Grenoble" labelsEnabled="0" symbologyReferenceScale="-1" maxScale="0" simplifyLocal="1" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyDrawingHints="0">
  ...
  <renderer-v2 type="singleSymbol" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <symbols>
      <symbol alpha="0.3" type="marker" clip_to_extent="1" name="0" frame_rate="10" is_animated="0" force_rhr="0">
        ...
        <layer id="{237dc8c7-2060-42c6-8401-aa1f8960fa9d}" class="SimpleMarker" pass="0" locked="0" enabled="1">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" type="marker" clip_to_extent="1" name="" frame_rate="10" is_animated="0" force_rhr="0">
        ...
        <layer id="{dcf1cefc-6907-499f-8969-2cea5ce798a2}" class="SimpleMarker" pass="0" locked="0" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
  ...
  <aliases>
    ...
    <alias name="" index="10" field="Material"/>
    <alias name="" index="11" field="Placement"/>
    <alias name="" index="12" field="Description"/>
    <alias name="" index="13" field="ParentOghObjectType"/>
    <alias name="" index="14" field="ParentObjectId"/>
    <alias name="" index="15" field="ParentRootId"/>
    <alias name="" index="16" field="ParentStartDate"/>
    <alias name="" index="17" field="ParentEndDate"/>
  </aliases>
  <splitPolicies>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="ConvElementType"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="ConvElementType" notnull_strength="0" exp_strength="0" unique_strength="0"/>
